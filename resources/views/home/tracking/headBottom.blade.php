@if (config('app.env') == "live" || config('app.env') == "production")
    ...
    <script>
        ...
        fbq('init', '996333227897541');
        fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=996333227897541&ev=PageView&noscript=1"/></noscript>
    <!-- End Meta Pixel Code -->
@endif
