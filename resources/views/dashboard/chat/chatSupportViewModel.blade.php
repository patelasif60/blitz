...
{{--    <div class="head text-white" style="cursor: pointer" onclick="chat.chatPreviewPage('#allchatlist')">--}}
    <div class="head text-white" style="cursor: pointer">
        <span class="pe-2 d-none" id="removeBackIcon" onclick="chat.chatPreviewPage('#chatgrouplist')">
                ...
                <div class="input-group mb-0">
                    ...
                    <div class="action pe-1">
                        <div class="accordion accordion-flush  d-flex chat-accordion" id="chataccordionFlush">
                            ...
                            <div class="accordion-item support_chat">
                    ...
                    <span class="input-group-text send-color click" onclick="chat.sendMessageSupportOnclick(event, '', '{{ route("support-chat-create-ajax") }}', '{{ $chat_id??'' }}', '{{ $header_group_name }}', '{{ Auth::user()->id }}', '{{ Auth::user()->role_id }}', '{{ $company_id??'' }}')">
