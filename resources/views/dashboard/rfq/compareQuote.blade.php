...
<div class="compare-quote d-none" id="compare-quote">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <table class="table mb-0 table-bordered " id="qouteListing{{$rfqId}}">
                <thead class="table-light">
                    <tr>
                        ...
                        <th class=" text-center QC-font text-nowrap">{{ __('rfqs.logistics_by') }}</th>
                ...
                <tbody>
                    @foreach($compareQuote as $quote)
                        <tr>
                                                    ...
                                                    <table class="table mb-0 border w-100">
                                                        ...
                                                        @foreach($all_products as $key => $value)
                                                            @php
                                                                ...
                                                                if(!in_array($value->product_id, array_column($quote->getQuoteProducts, 'rfq_product_id'))){
                            ...
                            <td class=" text-center QC-font text-nowrap">{{$quote->supplier_company_name}}</td>
