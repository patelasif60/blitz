        ...
        <tr>
            <td align="center">
                <table width="800" cellpadding="5" cellspecing="0"
                    ...
                    <tr>
                        <td align="center">
                            <h1 style="font-size: 36px;color: #002050; text-align: center;"> Kami senang Anda bergabung.<br>{{ $user['user']->firstname . ' ' . $user['user']->lastname }}</h1>
                        </td>

                    </tr>
                    <tr>
                        <td align=" center" style="text-align: center; padding-top: 30px;padding-bottom: 30px;">
                            <a href="{{ $user['url'] }}"><img src="https://www.blitznet.co.id/front-assets/images/front/activationbutton.png" alt="{{ $user['url'] }}"></a><br>
                            <div style="margin-top: 20px;">OR<br><br><a href="{{ $user['url'] }}" style="font-weight: bold; color: #0D6EFD;">Klik disini</a></div>
                        </td>
                    </tr>
                    @if($user['user']->role_id == 3)
                        @if(isset($user['flag']) && $user['flag'] == 1)
                            <tr></tr>
                        @else
                            <tr>
                                <td align="center">
                                    <p style="font-size: 16px; text-align: center;">kata sandi masuk Anda adalah <strong>{{ $user['password'] }}</strong></p>
                                </td>
                            </tr>
                        @endif
                    @endif
