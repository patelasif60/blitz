            ...
            <table style="border: 0; padding:0; margin:0 auto;text-align: left; width:750px; background-color:#fff; font-size:14px;font-family: Arial, sans-serif;" border="0" cellspacing="10" cellpadding="0" width="">
                        ...
                        <tr>
                            <td style="color: #808080;font-size: 16px;">
                                Halo <strong>{{ $order['order']->suppliers_name }}</strong> ,
                            </td>
                        </tr>
                        <!-- <tr style="line-height: 20px;">
                            <td>&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td style="color: #808080;font-size: 16px;">
                                ...
                                <p>Anda telahmenerima Order baru<strong> {{ $order['order']->order_number }}</strong>. Mohon agar
                                    disiapkan dan infokan kami jika barang sudah bisa di kirimkan.
                                </p>
                                <p>Detail Order sbgberikut :</p>
