    ...
    <tr>
        <td align="center" style="background-color: #f9f9f9;">
            <table style="border: 0; padding:0; margin:0 auto;text-align: left; width:750px; background-color:#fff; font-size:14px;font-family: Arial, sans-serif;" border="0" cellspacing="10" cellpadding="0" width="">
                ...
                <tr>
                    <td style="color: #808080;font-size: 16px;">
                        <p>Terima kasih atas minat pengajuan kredit bisnis anda bersama Blitznet. Bersama dengan ini kami menyampaikan tanggapan terhadap pengajuan kredit yang di terima pada <strong>{{changeDateFormat($order->created_at,'d/m/Y')}}</strong>. Bahwa pengajuan atas kredit tersebut diterima.</p>
