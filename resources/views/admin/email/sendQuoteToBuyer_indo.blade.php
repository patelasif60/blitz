...
<body>
    <table style="border: 0; padding:0; margin:0 auto;text-align: left; font-size:14px;font-family: Arial, sans-serif;" border="0" cellspacing="0" cellpadding="0" width="100%">
        <tbody>
            ...
            {{-- <tr>
                <th style="color: #000;font-size: 30px;font-weight: 800;">Quotation untuk
                    {{ $quote['quote']->reference_number }} anda di terima
            </th>
            </tr> --}}
                    ...
                    <table style="border: 0; padding:0; margin:0 auto;text-align: left; width:750px; background-color:#fff; font-size:14px;font-family: Arial, sans-serif;" border="0" cellspacing="10" cellpadding="0" width="">
                        ...
                        <tr>
                            <td style="color: #808080;font-size: 16px;">
                                Halo <strong> {{ $quote['quote']->firstname . ' ' . $quote['quote']->lastname }}</strong>,
                            </td>
                        </tr>
                        <!-- <tr >
                            <td>&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td style="color: #808080;font-size: 16px;">
                                ...
                                <p>Tanggapan untuk <strong> {{ $quote['quote']->reference_number }} </strong> sudah di terima.</p>
                                <p>
                                <table style="width: 100%;" cellpadding="5px" border="0">
                                    ...
                                    @foreach($quote['quote_item'] as $rfqProduct)
                                        <tr>
                                ...
                                {{-- <p>Produk yang Diminta: {{ $quote['quote']->category . ' ' . $quote['quote']->sub_category . ' ' . $quote['quote']->product . ' ' . $quote['quote']->product_description }}</p> --}}
                                <p>silahkan <a href="https://www.blitznet.co.id/signin">masuk Akun Anda</a> untuk memeriksa
                                    rincian
                                    lebih lanjut.</p>
                            </td>
                        </tr>
