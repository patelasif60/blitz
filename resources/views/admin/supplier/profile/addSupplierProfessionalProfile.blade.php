...
@section('content')
                    ...
                    <ul class="nav nav-tabs bg-white newversiontabs ps-3" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link px-0 active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home"
                                ...
                                aria-selected="true">{{ __('admin.add_supplier') }}</button>
                        </li>
                        <li class="nav-item ms-auto  me-3 mt-2">
                            <a href="#" target="_blank" id="previewBtn" class="btn btn-primary btn-sm disabled">Preview</a>
                        </li>
                    </ul>
                                ...
                                <div id="step-1" class="tab-pane p-0" role="tabpanel" style="display: none;">
                                    <div class="p-3 bg-white shadow supplierProfessionalPro">
                                        <ul class="nav nav-pills mb-3 justify-content-center" id="pills-tab" role="tablist">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link" id="pills-BasicDetails-tab" data-bs-toggle="pill"
                                                    data-bs-target="#pillsBasicDetails" type="button" role="tab"
                                                    aria-controls="pillsBasicDetails" aria-selected="false">
                                                    <span>3</span>
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link" id="pills-Highlights-tab" data-bs-toggle="pill"
                                                    data-bs-target="#pills-Highlights" type="button" role="tab"
                                                    aria-controls="pills-Highlights" aria-selected="false">
                                                    <span>6</span>
                                        ...
                                        <input type="hidden" id="clicked_by_pill" name="clicked_by_pill"
                                            value="0">
                                        <div class="tab-content p-0 " id="pills-tabContent">
                                            ...
                                            <div class="tab-pane fade show active bg-white" id="pills-CompanyDetails"
                                                ...
                                                <form class="" id="supplierEditForm" method="POST"
                                                    ...
                                                    action="{{ route('admin.supplier.storeSupplier') }}">
                                                    @csrf
                                                    ...
                                                    <div class="row">
                                                                ...
                                                                <div class="card-body p-3 pb-1">
                                                                    <div class="row">
                                                                        <div class="col-md-4 mb-3">
                                                                            ...
                                                                            <input type="text" class="form-control max-255" id="name" name="name" value="" placeholder="{{ __('admin.company_name_placeholder') }}" onkeypress="return preventQuote();">
                                                                        ...
                                                                        <div class="col-md-4 mb-3">
                                                                            ...
                                                                            <div class="d-flex">
                                                                                <span class=""><input type="file"
                                                                                        name="logo"
                                                                                        class="form-control"
                                                                                        id="logo"
                                                                                        accept=".jpg,.png,.gif,.jpeg"
                                                                                        onchange="show(this)"
                                                                                        hidden /><label class="upload_btn"
                                                                        ...
                                                                        <div class="col-md-4 mb-3">
                                                                            ...
                                                                            <input type="email" class="form-control max-255" id="email" name="email" value=""  placeholder="{{ __('admin.company_email_placeholder') }}"/>
                                                                            <small id="emailError" class="text-danger errorValidate"></small>
                                                                        </div>
                                                                        <div class="col-md-4 mb-3">
                                                                            <label for="mobile" class="form-label">{{ __('admin.company_mobile') }} </label>
                                                                            <input type="text" class="form-control input-number max-255" id="mobile" name="mobile" value=""   placeholder="XXXXXXXXXXX" maxlength="16">
                                                                        ...
                                                                        <div class="col-md-4 mb-3">
                                                                            ...
                                                                            <input type="text" class="form-control input-number max-255" id="company_alternative_phone" name="company_alternative_phone" placeholder="XXXXXXXXXXX" maxlength="16">
                                                                        ...
                                                                        <div class="col-md-4 mb-3">
                                                                            ...
                                                                            <input type="text" class="form-control max-255" id="website" name="website" value="" placeholder="{{ __('admin.company_website_placeholder') }}">
                                                                        ...
                                                                        <div class="col-md-3 mb-3 d-none">
                                                                            ...
                                                                            <input type="text" class="form-control" id="interested_in" name="interested_in" value="" placeholder="{{ __('admin.dealing_with_categories_placeholder') }}">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-3 mb-3">
                                                                            ...
                                                                            <div class="d-flex">
                                                                                ...
                                                                                <input type="text" name="contactPersonName" id="contactPersonName" class="form-control input-alpha-numeric max-255" value=""  placeholder="{{ __('admin.first_name_placeholder')}}" maxlength="255">
                                                                            </div>
                                                                            <small id="contactPersonNameError" class="text-danger errorValidate"></small>
                                                                        </div>
                                                                        <div class="col-md-3 mb-3">
                                                                            <label for="contactPersonLastName" class="form-label"> {{ __('admin.contact_person_last_name')}}</label>
                                                                            <input type="text" name="contactPersonLastName" id="contactPersonLastName" class="form-control input-alpha-numeric max-255" value=""  placeholder="{{ __('admin.last_name_placeholder')}}">
                                                                            <small id="contactPersonLastNameError" class="text-danger errorValidate"></small>
                                                                        </div>
                                                                        <div class="col-md-3 mb-3">
                                                                            <label for="contactPersonEmail" class="form-label">{{ __('admin.contact_person_email') }}<span class="text-danger">*</span></label>
                                                                            <input type="email" name="contactPersonEmail" id="contactPersonEmail" class="form-control max-255" value="" placeholder="{{ __('admin.email_placeholder') }}">

                                                                            <small id="contactPersonEmailError" class="text-danger errorValidate"></small>

                                                                        </div>
                                                                        <div class="col-md-3 mb-3">
                                                                            <label for="contactPersonEmail" class="form-label">{{ __('admin.altenate_email') }}</label>
                                                                            <input type="email" name="alternate_email" id="alternate_email" class="form-control max-255" value="" placeholder="{{ __('admin.email_placeholder') }}">
                                                                            <small id="alternate_emailError" class="text-danger errorValidate"></small>

                                                                        </div>
                                                                        <div class="col-md-3 mb-3">
                                                                            <label for="contactPersonMobile" class="form-label">{{ __('admin.contact_person_phone') }}</label>
                                                                            <input type="text" class="form-control input-number max-255" id="contactPersonMobile" name="contactPersonMobile"  placeholder="XXXXXXXXXXX" value="" maxlength="16">
                                                                            <small id="contactPersonMobileError" class="text-danger errorValidate"></small>
                                                                ...
                                                                <div class="card-body p-3 pb-1">
                                                                    <div class="row">
                                                                        <div class="col-md-3 mb-3">
                                                                            ...
                                                                            <input type="text" class="form-control input-number" id="nib" name="nib" value="" maxlength="13" >
                                                                        ...
                                                                        <div class="col-md-3 mb-3">
                                                                            ...
                                                                            <input type="text" class="form-control input-npwp" id="npwp" name="npwp" value="" placeholder="11.222.333.4-555.666"  >
                                                                            <small id="npwpError" class="text-danger errorValidate"></small>
                                                                        ...
                                                                        <div class="col-md-3 mb-3">
                                                                            ...
                                                                            <div class="d-flex">
                                                                                    ...
                                                                                    <label class="upload_btn" for="npwp_file">{{ __('admin.npwp_file') }}</label></span>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <div class="d-flex ms-2">
                                                                                ...
                                                                                <div class="form-check ms-4">
                                                                                    <input class="form-check-input pkp-btn"
                                                                                        type="radio" name="companyType"
                                                                                        id="exampleRadios1"
                                                                                        value="1">
                                                                                    <label class="form-check-label"
                                                                                        for="exampleRadios1"> PKP
                                                                                    </label>
                                                                                </div>
                                                                        ...
                                                                        <small id="companyTypeError" class="text-danger"></small>

                                                                        <div class="col-md-3 mb-3">
                                                                            <label for="group_margin" class="form-label">{{ __('admin.group_margin') }} % </label>
                                                                            <input type="text" class="form-control" id="group_margin" name="group_margin" value="0" onkeypress="return isNumberKey(this, event);">
                                                                        ...
                                                                        <div class="col-md-3 mb-3">
                                                                            ...
                                                                            <input type="text" class="form-control max-255" id="licence" name="licence" value="" placeholder="{{ __('admin.licence_placehoder')}}">
                                                                            <small id="licenceError" class="text-danger errorValidate"></small>

                                                                        </div>
                                                                        <div class="col-md-3 mb-3">
                                                                            <label for="facebook"  class="form-label">{{ __('admin.facebook')}}</label>
                                                                            <input type="text" class="form-control max-255" id="facebook" name="facebook" value="" placeholder="{{ __('admin.facebook_placehoder')}}">
                                                                            <small id="facebookError" class="text-danger errorValidate"></small>
                                                                        </div>
                                                                        <div class="col-md-3 mb-3">
                                                                            <label for="twitter" class="form-label">{{ __('admin.twitter')}}</label>
                                                                            <input type="text" class="form-control max-255" id="twitter"  name="twitter" value="" placeholder="{{ __('admin.twitter_placeholder')}}">
                                                                            <small id="twitterError" class="text-danger errorValidate"></small>

                                                                        </div>
                                                                        <div class="col-md-3 mb-3">
                                                                            <label for="linkedIn" class="form-label">{{ __('admin.linkedIn')}}</label>
                                                                            <input type="text" class="form-control max-255" id="linkedIn" name="linkedIn" value="" placeholder="{{ __('admin.linkedIn_placeholder')}}">
                                                                            <small id="linkedInError" class="text-danger errorValidate"></small>

                                                                        </div>
                                                                        <div class="col-md-3 mb-3">
                                                                            <label for="youtube" class="form-label">{{ __('admin.youtube')}}</label>
                                                                            <input type="text"  class="form-control max-255" id="youtube" name="youtube" value="" placeholder="{{ __('admin.youtube_url_placeholder')}}">
                                                                            <small id="youtubeError" class="text-danger errorValidate"></small>

                                                                        </div>
                                                                        <div class="col-md-3 mb-3">
                                                                            <label for="instagram" class="form-label">{{ __('admin.instagram')}}</label>
                                                                            <input type="text"  class="form-control max-255" id="instagram" name="instagram" value="" placeholder="{{ __('admin.instagram_placeholder')}}">
                                                                            <small id="instagramError" class="text-danger errorValidate"></small>

                                                                        </div>
                                                                        <div class="col-md-3 mb-3">
                                                                            <label for="expected_date" class="form-label">{{ __('admin.established')}}</label>
                                                                            <div id="date" class="input-group date datepicker">
                                                                                <input type="text" readonly="" placeholder="{{ __('admin.established_placeholder')}}" id="established_date" name="established_date" class="form-control" style="border: 1px solid #dee2e6;background-color:white;" >
                                                                                <span class="input-group-addon input-group-append border-left">
                                                                                            <span class="mdi mdi-calendar input-group-text" style="border: 1px solid #dee2e6;"></span>
                                                                                        </span>
                                                                                <small id="established_dateError" class="text-danger errorValidate"></small>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div id="mainLocationInHtml" class="card-body p-3 pb-1">
                                                                    ...
                                                                    <div class="row location_in_html">
                                                                        <div class="col-md-12 mb-3">
                                                                            ...
                                                                            <span class="icon float-end supplierCompanyDelete trashicon hidden" style=""><a href="javascript:void(0)" id="" class="text-danger"><i class="fa fa-trash"></i></a></span>
                                                        ...
                                                        <div class="col-md-12 mb-2">
                                                            ...
                                                            <div class="text-end">
                                                                <button class="btn btn-primary" type="submit" class="companyDetailCls" id="companydetailsSubmit">{{ __('admin.save') }}</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
                                            ...
                                            <div class="tab-pane fade bg-white" id="pills-BusinessDetails"
                                                ...
                                                tabindex="0">
                                                @livewire('supplier.profile.business-details', ['supplier_id' => null, 'categories'=>'[]'])
                                                @livewireScripts
                                            </div>

                                        <!-- Section 2 End -->
                                            <!-- Section 3 Start -->
                                            <div class="tab-pane fade bg-white" id="pillsBasicDetails" role="tabpanel"
                                                aria-labelledby="pills-BasicDetails-tab" tabindex="0">
                                                @livewire('supplier.profile.basic-details', ['supplier_id' => null])
                                            </div>
                                            <!-- Section 3 End -->
                                            <!-- Section 4 Start -->
                                            <div class="tab-pane fade bg-white" id="pills-CoreTeam" role="tabpanel"
                                                ...
                                                @livewire('supplier.profile.core-team', ['userId' => null, 'supplier_id' => null, 'company_user_type' => 1, 'slug' => 'coreteam', 'typeName' => 'Core Team'])
                                            </div>
                                            <!-- Section 4 End -->
                                            <!-- Section 5 Start -->
                                            <div class="tab-pane fade bg-white" id="pills-Portfolio" role="tabpanel"
                                                aria-labelledby="pills-Portfolio-tab" tabindex="0">
                                                @livewire('supplier.profile.portfolio', ['supplier_id' => null, 'companyDetails' => null])
                                            </div>
                                            <!-- Section 5 End -->
                                            <!-- Section 6 Start -->
                                            <div class="tab-pane fade bg-white" id="pills-Highlights" role="tabpanel"
                                                aria-labelledby="pills-Highlights-tab" tabindex="0">
                                                @livewire('supplier.profile.company-highlights')
                                            </div>
                                            <!-- Section 6 End -->
                                            <!-- Section 7 Start -->
                                            <div class="tab-pane fade bg-white" id="pills-others" role="tabpanel"
                                                aria-labelledby="pills-others-tab" tabindex="0">
                                                @livewire('supplier.profile.testimonial', ['company_user_type' => 2, 'slug' => 'testimonial', 'typeName' => 'Testimonial'])
                                                <!--  -->
                                                @livewire('supplier.profile.company-partner', ['company_user_type' => 3, 'slug' => 'partner', 'typeName' => 'Company Partner'])
                                                <!--  -->
                                                @livewire('supplier.profile.gallery')
                                            ...
                                            <div class="card">
                                                <div class="card-header d-flex align-items-center">
                                                    <h5 class="mb-0"><img height="20px"
                                                            src="{{ URL::asset('assets/icons/credit-card.png') }}"
                                                            alt="Charges" class="pe-2">
                                                        <span>{{ __('admin.bank_details') }}</span>
                                                    </h5>
                                                </div>
                                                <div class="card-body p-3 pb-1">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12 mb-3 newtable_v2 ">
                                                            <div class="table-responsive">
                                                                <table id="supplierBankTable" class="table"
                                                                    style="width: 100%;">
                                                                    <thead>
                                                                        <tr class="bg-light">
    ...
    {{-- Stpe-2 --}}
    <div class="modal error_res fade version2" id="addProductModal" data-bs-backdrop="static" tabindex="-1"
                ...
                <div class="modal-body p-3">
                    <div class="">
                        <form id="supplierProductForm" enctype="multipart/form-data" class="form-group row g-3">
                            @csrf
                            <input type="hidden" id="product_supplier_id" name="product_supplier_id">
                            <div class="col-md-12 pb-2">
                                <div class="card">
                                    <div class="card-header d-flex align-items-center">
                                        <h5 class="mb-0 d-flex align-items-center"><img
                                                src="{{ URL('front-assets/images/icons/shopping-cart.png') }}"
                                                alt="Order Details" class="pe-2"> {{ __('admin.category_details') }}
                                        </h5>
                                    </div>
                                    <div class="card-body p-3 pb-1">
                        ...
                        <div class="card">
                            <div class="card-header d-flex align-items-center">
                                <h5 class="mb-0 d-flex align-items-center"><img height="20px"
                                        src="{{ URL('front-assets/images/icons/people-carry-1.png') }}"
                                        alt="Supplier Details" class="pe-2"> {{ __('admin.product_detail') }}</h5>
                            </div>
                            <div class="card-body p-3 pb-1">
                                <div class="row rfqform_view bg-white g-3">
                                    ...
                                    <div class="col-md-12 mb-3" id="">
                                        ...
                                        <input name="supplierProductDiscription" id="supplierProductDiscription"
                                            class="form-control" type="text" list="supplierProductDiscriptionList" />
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="supplierProductPrice"
                                            class="form-label">{{ __('admin.price') }}<span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="supplierProductPrice" id="supplierProductPrice"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="supplierProductMinQuantity"
                                            id="supplierProductMinQuantity" class="form-control" min="1"
                                            onchange="minOrderQty(this)" onkeypress="return isNumberKey(this, event);">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="supplierProductMaxQuantity"
                                            ...
                                            data-parsley-type="number" data-parsley-minlength="1" min="1"
                                            onchange="maxOrderQty(this)" onkeypress="return isNumberKey(this, event);"
                                            required>
                                            ...
                                            <div class="row productDiv g-2" id="group_productDiv">
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    ...
                                                    <input type="text" id="discount" name="discount[]"
                                                        class="form-control discountVal" required
                                                ...
                                                <div class="col-md-1 pt-1 mb-3 ">
                                                    ...
                                                    <div style="line-height: 38px;" id="deleteBtn" name="deleteBtn[]"><span
                                                            class="icon deleteRange d-none"><a href="javascript:void(0)"
                                                                id="deleteBtn" class="text-danger removeRange "><i
                                                                    class="fa fa-trash mt-3"></i></a></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-3 pb-1">
                            <div class="row rfqform_view">
                                <form id="supplierBankForm" enctype="multipart/form-data" class="form-group"
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="d-flex error_ui">
                                                <select class="form-select w-100 text-primary" name="bank_id"
                                                    id="bank_id" required onchange="bankChange($(this))">
                                                ...
                                                <div class="p-1 pe-2 "><img src="{{ URL('assets/icons/bank.png') }}"
                                                        height="20px" width="20px" alt="bank Logo"
                                                        id="bank-logo"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 ps-3  mb-3">
                                            <div class="">
                                                <label for="bank-code" class="form-label">{{ __('admin.bank_code') }}
                                                </label>
                                                <input type="text" class="form-control" id="bank-code"
                                                    value="XXXXXXXX" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-flex pb-2">
                                        <div class="col-md-6  mb-3">
                                            <div class="error_ui">
                                                ...
                                                <input type="text" class="form-control" id="bank-name"
                                                    ...
                                                    data-parsley-pattern="^[a-zA-Z ]+$" placeholder="John Doe">
                                            </div>
                                        </div>
                                        <div class="col-md-6 ps-3  mb-3">
                                            <label for="bank-account" class="form-label">{{ __('admin.bank_account_number') }}<span class="text-danger">*</span></label>
                                            <input type="text" class="form-control input-alpha-numeric" id="bank-account" name="bank_account_number" maxlength="18" data-parsley-pattern="[0-9]+" data-parsley-length="[8, 18]" required placeholder="XXXXXXXXXXXXXX">
                                        </div>
                                    </div>
                                    <div class="col-md-12 pb-2">
                                        <div class="">
                                            ...
                                            <textarea class="form-control" placeholder="{{ __('admin.description') }}" id="description"
    ...
    <script>
        ...
        $(document).ready(function() {
                    ...
                    if (currentStepIndex == 0) {
                        ...
                        if (currentActiveTab == "pills-CompanyDetails-tab") {
                            ...
                            if ($("#businessDetailsFrm").find('.inputErrors').val() != "") {
                                $("#businessDetailsFrm").find("textarea:empty:visible,input[value='']:visible")
                                    .first().focus();
                                return false;
                            } else {
                                return true;
            ...
            $(document).on("click", "#AddProductData", function(e) {
                ...
                if ($("#supplierProductForm").parsley().validate()) {
                    ...
                    //end checking
                    var supplierId = $("#supplierProductForm #product_supplier_id").val();
                    ...
                    $.ajax({
                        ...
                        success: function(successData) {
                            if (successData.supplierProductCount == 0) {
                                ...
                                $("#product_supplier_id").val(supplierId);
                            } else {
            ...
            $('#addProductModal').on('hide.bs.modal', function(e) {
                ...
                var product_supplier_id = $('#product_supplier_id').val();
                $("#supplierProductForm")[0].reset();
                setTimeout(function () {
                    $('#supplierProductForm #product_supplier_id').val(product_supplier_id);
                }, 1000);
                editSupplierProductId = '';
            });
            ...
            $(document).on("click", "#saveBankData", function(e) {
                ...
                if ($("#supplierBankForm").parsley().validate()) {
                    ...
                    formData.append("supplier_id", $("#supplierProductForm #product_supplier_id").val());
        ...
        function setSupplierDataOnDatatable(data) {
            ...
            if (data.is_edit) {
                ...
                let tableData = '<tr id="addbankdetails_' + supplier_bank_details.id + '" class="odd">\n' +
                    ...
                    '                                        </div>\n' +
                    '                                    </td>\n' +
                    '                                    <td class="text-end text-nowrap" id="t_action_' +
                    supplier_bank_details.id + '"> <a href="javascript:void(0)" data-id="' + supplier_bank_details.id +
                    '" class="editSupplierBankDetails"><i class="fa fa-edit" style="color: #3f80ea;"></i></a>\n' +
                    '                                        <a href="javascript:void(0)" data-id="' + supplier_bank_details
                    .id + '" class="deletebankdetails ps-2"> <i class="fa fa-trash" style="color: #d9534f;"></i></a>\n' +
                    '                                    </td>\n' +
                    '                                </tr>';
                ...
                for (var i = 0; i < allowed_extensions.length; i++) {
                    if (allowed_extensions[i] == file_extension) {
                        ...
                        $('#file-' + input.name).append('<span class="ms-2"><a href="javascript:void(0);" id="' + input
                            .name + 'Download" title="' + tooltip + '" style="text-decoration: none">' + fileName +
                            '</a></span>');
                        return;
                    }
                }
                            ...
                            success: function(data) {
                                if (data.success) {
                                    if (data.supplierId != '') {
                                        ...
                                        $('#supplierEditForm').attr('action', updateAction);
                                        $('#supplierEditForm #id').val(data.supplierId);

                                        window.livewire.emit('get-supplier', data.supplierId);
                                        window.livewire.emit('get-basic', data.supplierId);
                                        window.livewire.emit('get-coreTeam', data.supplierId);
                                        window.livewire.emit('get-highlights', data.supplierId);
                                        window.livewire.emit('get-portfolio', data.supplierId);
                                        window.livewire.emit('get-Testimonial', data.supplierId);
                                        window.livewire.emit('get-CompanyPartner', data.supplierId);
                                        window.livewire.emit('get-gallery', data.supplierId);
                                        $('#groupImageEdit #supplier_id_gallary').val(data.supplierId);
                                        $('#supplierProductForm #product_supplier_id').val(data.supplierId);
        ...
        /** Supplier Professional profile snippet END*/
    </script>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('input[name="company_alternative_phone_code"]').val('62');
