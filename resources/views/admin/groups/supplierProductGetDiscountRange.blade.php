...
{{--                <input type="hidden" id="custom_add" name="custom_add[]" value="0">--}}
                <div class="col-md-2 mb-3">
                    ...
                    <input {{$key == $lastArrayKey ? '' : 'readonly'}} type="text" id="min_qty" name="min_qty[]" class="form-control cloanMinQty resetFeild" onchange="minQty(this)" onkeypress="return isNumberKey(this, event);" required value="{{ !empty($supplierProductDiscountRanges) ? $supplierProductDiscountRanges[0]->min_qty : 0 }}">
                ...
                <div class="col-md-2 mb-3">
                    ...
                    <input {{$key == $lastArrayKey ? '' : 'readonly'}} type="text" id="max_qty" name="max_qty[]" class="form-control cloanMaxQty resetFeild" onchange="maxQty(this)" onkeypress="return isNumberKey(this, event);" required value="{{ !empty($supplierProductDiscountRanges) ? $supplierProductDiscountRanges[0]->max_qty : 0 }}">
                ...
                <div class="col-md-2 mb-3">
                    ...
                    <input {{$key == $lastArrayKey ? '' : 'readonly'}} type="text" id="discount" name="discount[]" class="form-control discountVal resetFeild" required value="{{ !empty($supplierProductDiscountRanges) ? $supplierProductDiscountRanges[0]->discount : 0 }}" onkeypress="return isNumberKey(this, event);" min="0" max="100" data-parsley-trigger="keyup" data-parsley-type="number">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input type="text" id="discount_price" name="discount_price[]" class="form-control discountAmount resetFeild" value="{{ !empty($supplierProductDiscountRanges) ? $supplierProductDiscountRanges[0]->discounted_price : 0 }}" readonly>
                </div>
            ...
            <div class="row productDiv" id="group_productDiv">
                ...
                <div class="col-md-2 mb-3">
                    ...
                    <select class="form-select unitVal" id="unit" name="unit[]" disabled>
                        <option disabled selected>{{ __('admin.select_unit') }}</option>
                        @foreach ($units as $unit)
                            <option value="{{ $unit->id }}" {{ !empty($unit) && $unit->id == $supplierUnit ? "selected" : '' }} >{{ $unit->name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-md-2 mb-3">
