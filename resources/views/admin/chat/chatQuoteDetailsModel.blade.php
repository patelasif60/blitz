    ...
    <div class="chat-content p-3 pb-1">
        ...
        <div class="chat-type-content mt-auto">
            ...
            <div class="multiple-buttons d-flex justify-content-start align-items-center px-3 py-2">
                ...
                <a href="javascript:void(0)" class="ms-auto" onclick="chat.sendMessageBackendOnClick(event, this, '{{ route("chat-create-backend-ajax") }}','{{ $id }}', '{{ $chat_id??'' }}', '{{ $type }}', '{{ $header_group_name }}', '{{ Auth::user()->id }}', '{{ Auth::user()->role_id }}', '{{ $company_id }}')">
...
<script>
    ...
    function showEmoji() {
        ...
        $('#smiley_Quote').html(emoji);
    }
    /*function hideEmojiPanel() {
        $('#emoji').addClass('d-none')
    }*/
    function getEmoji(control) {
        document.getElementById('chatInput_Quote').value += control.innerHTML;
