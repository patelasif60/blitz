        ...
        <section>
            <div class="registration-sec container-fluid">
                <div class="registration-blk row">
                    <div class="supplier-Login-Image position-relative col-md-6 px-0 d-none d-md-flex">
                            ...
                            <div class="col-md-9 d-flex flex-column align-items-center justify-content-center">
                                <div class="w-100 px-md-4 px-2">
                                    ...
                                    <div id="passwordLogin">
                                        <form autocomplete="off" id="supplierLogInForm" method="POST" action="{{ route('admin-login') }}">
                                            @csrf
                                            <div class="col-md-12 form-group mb-3 position-relative">
                                                ...
                                                <input type="email" style="padding: 0.375rem 0.75rem 0.375rem 3.5rem;" onkeypress="errorRemove(this)" id="email" class="form-control" name="email">
                                            ...
                                            <div class="mb-3">
                                                <button type="submit" name="userLogin" id="supplierLogInBtn" class="btn btn-primary reg_btn">
                                                    {{ __('home.Login') }}
                                                </button>
                                            </div>
                                        </form>
                                    ...
                                    <div id="OtpLogin" class="hidden">
                                        <form autocomplete="off" action="{{route('supplierloginwithotp')}}" name="mobileLoginform" id="mobileLoginform" method="POST" class="h-100" data-parsley-validate>
                                            @csrf
                                            <input type="hidden" name="frmType" id="frmType" value="backend">
                                            <div class="col-md-12 form-group mb-3">
                                                <label class="form-label">{{ __('profile.mobile_number') }}
                                                    <span style="color:red">*</span>
                                                </label>
                                                <input type="text" class="form-control" id="mobile" data-parsley-checkmobilenotexist data-parsley-checkmobilenotexist-message="{{ __('frontFormValidationMsg.checkmobilenotexist') }}" name="mobile" required data-parsley-type="digits" data-parsley-required-message="{{ __('frontFormValidationMsg.mobile') }}" data-parsley-length="[9, 16]" data-parsley-length-message="{{ __('profile.required_phone_number_error') }}" data-parsley-type="digits" data-parsley-type-message="{{ __('frontFormValidationMsg.numeric') }}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 d-md-flex align-items-center justify-content-center">
                                            <span class="login_txt  me-2">{{__('admin.supplier_dont_account')}}</span>
                                            <a href="{{ route('signup-supplier') }}" class="text-decoration-none">
                                            <span class="video_txt">{{__('admin.supplier_create_account')}}</span></a>
                                        </div>
                                    </div>
                                    <div class=" d-flex justify-content-center mt-3 mt-lg-5" >
                                        ...
                                        <span class="video_txt">{{__('admin.buyer_login')}}</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
