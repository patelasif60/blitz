            ...
            <div class="col-12">
                <ul class="nav nav-tabs bg-white newversiontabs ps-3" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link px-0 active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">{{ __('admin.add_unit')}}</button>
                    </li>
                </ul>
                <div class="tab-content pt-3 pb-0" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    <form class="" method="POST" id="addunit" enctype="multipart/form-data" action="{{ route('unit-create') }}"
...
<script>
    $("#addunit").on('submit',function(event){
        ...
        var formData = new FormData($("#addunit")[0]);
                ...
                success: function (r) {
                    if(r.success == true) {
                        ...
                        $.toast({
                            ...
                            text: "{{__('admin.units_added_alert')}}",
