        ...
        <div class="registration-blk row">
            ...
            <div class="registration-form col-md-6 align-items-center justify-content-center new_page_reg">
                <div class="btn-group home_lenguage p-2 ms-auto position-absolute  mt-2" style="right: 0px;">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown_new border-0 "
                ...
                <div class="row align-items-center justify-content-center vh-100 new_page_reg">
                    <div class="col-md-9 d-flex align-items-center justify-content-center flex-column">
                        <div class="w-100 px-md-4 px-2">
                            <div class="mb-xxl-3 mb-3 mt-5 d-flex justify-content-center">
                                <div class="reg-above_txt" style="font-size: 1.5rem;">      {{ __('signup.forget_password') }}
                                </div>
                            </div>

                            <form autocomplete="off" id="userLoginForm" method="POST" action="{{ route('admin-forget-password-post') }}">
                                @csrf
                                <div class="col-md-12 form-group mb-3 position-relative">
                                    ...
                                    @if(isset($user))
                                        <input type="email" style="padding: 0.375rem 0.75rem 0.375rem 3.5rem;" onkeypress="errorRemove(this)" id="email" class="form-control" value="{{ $user->email }}" name="email">
                                ...
                                <div class="forgot-password d-flex my-xxl-4 my-2">
                                    <a href="{{ route('admin-login-form') }}" class="ms-auto forgot">{{ __('signup.back_to_login') }}</a>
                                </div>

                                <div class="mb-3 ">
                                    <button type="submit" id="supplierForgetPassBtn" name="userLogin" class="btn btn-primary reg_btn">{{ __('home.submit') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
...
<script>
    ...
    $(document).ready(function() {
        $("#supplierForgetPassBtn").click(function(e) {
            e.preventDefault();
