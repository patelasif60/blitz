    ...
    <div class="col-12 grid-margin ">
        <div class="row">
            <div class="col-md-12 d-flex align-items-center mb-3">
                <h1 class="mb-0 h3"><th>{{ __('admin.department')}}</th></h1>
            ...
            <div class="col-12">
                <ul class="nav nav-tabs bg-white newversiontabs ps-3" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link px-0 active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">{{__('admin.add_department')}}
                        </button>
                    </li>
                ...
                <div class="tab-content pt-3 pb-0" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <form id="deptadd" class="" method="POST" enctype="multipart/form-data" action="{{ route('department-create') }}" data-parsley-validate>
                            @csrf
                            <div class="row">
...
@section('scripts')
<script>
    $("#deptadd").on('submit', function(event) {
        event.preventDefault();
        var formData = new FormData($("#deptadd")[0]);
        if ($('#deptadd').parsley().validate()) {
            $.ajax({
                ...
                success: function(r) {
                    if (r.success == true) {
                        ...
                        $.toast({
                            ...
                            text: "{{ __('admin.department_added_alert')}}",
