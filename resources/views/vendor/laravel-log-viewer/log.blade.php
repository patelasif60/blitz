...
<div class="container-fluid">
  <div class="row">
    <div class="col sidebar mb-3">
      ...
      <h1><i class="fa fa-calendar" aria-hidden="true"></i> Blitznet Logs</h1>
      <p class="text-muted"><i>by Blitznet</i></p>
    ...
    <div class="col-10 table-container">
      ...
      <div class="p-3">
        @if($current_file)
          ...
          @if(Auth::user()->hasRole('admin') && Auth::user()->id == App\Models\User::BUYERADMIN)
              -
...
<script>
  ...
  // otherwise the page will be white for a seconds...
