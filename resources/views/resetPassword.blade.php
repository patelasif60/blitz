...
<html lang="en">
    ...
    <body>
        <section>
            <form autocomplete="off" id="adminLoginForm" method="POST" action="{{ route('reset-password-post') }}">
                @csrf
                                ...
                                <div class="col-md-9 d-flex flex-column align-items-center justify-content-center">
                                    <div class="w-100 px-md-4 px-2">
                                        <div class="row justify-content-center py-3 py-lg-4">
                                            <div class="reg-above_txt text-start" style="font-size: 1.5rem;"> {{ __('profile.reset_password') }} </div>
                                        </div>
                                        <div class="success">
                                        ...
                                        <div class="col-lg-12 form-group mb-3">
                                            ...
                                            <input type="password" style="padding: 0.375rem 3.5rem;" class="form-control" onkeypress="errorRemove(this)" name="password_confirmation" id="password_confirmation">
                                        ...
                                        <div class="mb-3">
                                            <button type="button" name="userLogin" id="changePasswordBtn" class="btn btn-primary reg_btn">
                                                {{ __('home.submit') }}
                                            </button>
                                        </div>
                                    </div>
