      ...
      <div class="row gx-4 mx-lg-0 justify-content-center">
        ...
        <div class="col-lg-6 col-xl-9 py-2">
          <div class="header_top ">
            <h1 class="mb-0 text-center">Already Accepted </h1>
          </div>
          <div class="card radius_1 border-0">
            <div class="card-body text-center">
            <div class="text-center"><img src="{{ URL::asset('front-assets/images/icons/accept_user_invitation.png') }}" alt="Accept Order"></div>
            <h5 class="mb-3">You have already accepted this invitaion.</h5>
