            ...
            <div class="row mx-lg-0  justify-content-center">
                ...
                <!-- <div class="col-lg-6 col-xl-9 py-2">
                    <div class="header_top ">
                        <h1 class="mb-0 text-center">Feedback Submitted</h1>
                    </div>
                    <div class="card radius_1 border-0">
                        <div class="card-body text-center">
                            ...
                            <h5 class="mb-3">Your feedback is already submitted for this quote.</h5>
                        </div>
                    </div>
                </div> -->

                <div class="header_top px-0 pb-0">
                    <h1 class="mb-0 text-center text-danger">{{ __('profile.quote_details_rejected') }}</h1>
                    <h6 class="mt-2 text-center bg-dark text-white pb-1">{{ __('profile.feedback_already_submitted') }}.</h6>
                </div>

                <div class="col-lg-6 col-xl-8 py-2">
                    <div class="card radius_1 border-0">
                        <div class="card-body">
