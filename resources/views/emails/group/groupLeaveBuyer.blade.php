            ...
            <table
                ...
                <tr>
                    <td style="color: #808080;font-size: 16px;">
                        Hello <strong>{{ $group['group']->user_firstname .' '. $group['group']->user_lastname }}</strong>,
                    </td>
                </tr>

                <tr>
                    <td style="color: #808080;font-size: 16px; line-height: 1.4;">
                        <p>It is sad that you left the Group <strong>{{$group['group']->group_number}}</strong> for
                            <strong>{{$group['group']->product_name}}</strong>. In case you change your mind, you can again join the
                            group anytime. </p>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="color: #808080;font-size: 16px; ">
                        <p>You can get more Discount on the product as the total quantity of order increases.
                        </p>
                        <p>You will still receive Quote for <strong>BRFQ-{{$group['group']->rfq_id}}</strong> as an individual buyer from multiple suppliers.</p>
                    </td>
                </tr>
                <tr>
