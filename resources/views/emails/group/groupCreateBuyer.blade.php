    ...
    <tr>
        <td align="center" style="background-color: #f9f9f9;">
            <table style="border: 0; padding:0; margin:0 auto;text-align: left; width:750px; background-color:#fff; font-size:14px;font-family: Arial, sans-serif;"
                ...
                <tr>
                    <td style="color: #808080;font-size: 16px;">
                        <p>We are here to offer you the best pricing for.</p>
                        ...
                        <p>You can get more Discount on the product as the total quantity of order increases</p>
                        ...
                        <p style="line-height: 1.4;">Let's attract more buyers about the group by sharing it on social media and let them know about the best pricing which will help you to decrease your pricing.</p>
