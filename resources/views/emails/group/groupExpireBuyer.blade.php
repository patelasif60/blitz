...
<head>
    ...
    <title>Group About to expire mail</title>
    <style>
        body,
        html {
            margin: 0;
    ...
    <tr>
        <td align="center" style="background-color: #f9f9f9;">
            <table style="border: 0; padding:0; margin:0 auto;text-align: left; width:750px; background-color:#fff; font-size:14px;font-family: Arial, sans-serif;" border="0" cellspacing="10" cellpadding="0" width="">
                ...
                <tr>
                    <td style="color: #808080;font-size: 16px;">
                        <p>This is to inform you that the Group <strong>{{ $group->group_number . ' ' . $group->name }}</strong> is about to expire. Do not miss on this opportunity to grab the best discount.</p>
                        ...
                        <table style="width: 100%;" cellpadding="5px" border="0">
                            ...
                            <tr>
                                ...
                                @endif
                                <td style="border-bottom: 1px solid #ccc; color: #ff0000; text-align: center;">{{ date('d M Y', strtotime($group->end_date)) }}</td>
                            </tr>
                        </table>
                ...
                <tr>
                    <td style="color: #808080;font-size: 16px; text-align: center;">
                        <i>Place order and avail the best discount.</i>
                    </td>
                </tr>
                <tr>
                    <td style="color: #808080;font-size: 16px; text-align: center;">
                ...
                <tr>
                    <td style="color: #808080;font-size: 16px; text-align: center;">
                        Let's attract more buyers about the group by sharing it on social media and let them know about the best pricing which will help you to decrease your pricing.
                    </td>
                </tr>
                <tr>
                    <td style="color: #808080;font-size: 16px;">
