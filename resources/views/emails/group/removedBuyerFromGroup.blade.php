...
<head>
    ...
    <title>Group Removed mail</title>
    <style>
        body,
        html {
            margin: 0;
            ...
            <table style="border: 0; padding:0; margin:0 auto;text-align: left; width:750px; background-color:#fff; font-size:14px;font-family: Arial, sans-serif;" border="0" cellspacing="10" cellpadding="0" width="">
                ...
                <tr>
                    <td style="color: #808080;font-size: 16px; line-height: 1.4;">
                        <p>It is sad that you were removed from the Group {{$group['group']->group_number}} for <strong>{{$group['group']->product_name}}</strong> due to some internal reasons. You will still receive Quote for <strong>BRFQ-{{$group['group']->rfq_id}}</strong> as an individual buyer from multiple suppliers. </p>
                    </td>
                </tr>
                <tr>
