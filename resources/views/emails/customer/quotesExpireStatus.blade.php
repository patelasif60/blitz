                    ...
                    <table style="border: 0; padding:0; margin:0 auto;text-align: left; width:750px; background-color:#fff; font-size:14px;font-family: Arial, sans-serif;" border="0" cellspacing="10" cellpadding="0" width="">
                        ...
                        <tr>
                            <td style="color: #808080;font-size: 16px;">
                                Halo, {{ $quote_expire['firstname'] . ' ' . $quote_expire['lastname'] }},
                            </td>
                        </tr>
                        <tr>
                            <td style="color: #808080;font-size: 16px;">
                                ...
                                <table style="width: 100%;" cellpadding="5px" border="0">
                                    ...
                                    @foreach($quote_expire['multipleProductDetails'] as $rfqProduct)
                                        <tr>
                                ...
                                <br>
                                <p> Untuk Quotation <strong>{{ $quote_expire['quote_number'] }}</strong> yang terkirim pada <strong>{{ $quote_expire['created']->format('m/d/Y') }}</strong>, sudah tidak berlaku. Untuk menerima penawaran baru silahkan membuat RFQ baru. </p>
                                <p> Silahkan <a href="https://www.blitznet.co.id/signin"> Login
                                        Akunanda</a> melihat update lebih lanjut. </p>
                            </td>
                        </tr>
                    </table>
                </td>
