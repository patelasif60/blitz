            ...
            <table style="border: 0; padding:0; margin:0 auto;text-align: left; width:750px; background-color:#fff; font-size:14px;font-family: Arial, sans-serif;" border="0" cellspacing="10" cellpadding="0" width="">
                ...
                <tr>
                    <td style="color: #808080;font-size: 16px;">
                        Halo, <strong> {{ $payment_due['firstname'] . ' ' . $payment_due['lastname'] }} </strong>,
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="color: #808080;font-size: 16px;">
                        ...
                        <table style="width: 100%;" cellpadding="5px" border="0">
                            ...
                            @foreach($payment_due['multipleProductDetails'] as $rfqProduct)
                                <tr>
                        ...
                        <br>
                        <p> Pesanan Anda atas <strong>{{ $payment_due['order_no'] }}</strong> dengan Nominal <strong>{{ $payment_due['amount'] }}</strong> telah di terima dan tagihan pembayaran-nya sudah memasuki jatuh tempo. Mohon selesaikan pembayaran segera. </p>
                        {{--<p> Klik disini untuk lakukan pembayaran @LinkPembayaran. </p>--}}
                    </td>
                </tr>
            </table>
        </td>
