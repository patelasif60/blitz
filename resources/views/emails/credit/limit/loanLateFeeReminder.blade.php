                ...
                <tr>
                    <td>
                        <table border="0" width="90%" style="margin: 0 auto;" align="center" cellpadding="0">
                            <tr>
                                <td>
                                    <h1 style="font-size: 30px;color: #002050; text-align: left; margin-bottom: 10px;">Halo {{ isset($data) ? $datauser->full_name : ''}},</h1>
                                </td>
                            </tr>
                        </table>
                    </td>
                            ...
                            <tr>
                                <td style="">
                                    <table border="0" width="100%" style="margin: 0" align="center" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td>
                                                <p>Tanggal jatuh tempo pinjaman Anda adalah dalam 14 hari.</p>
