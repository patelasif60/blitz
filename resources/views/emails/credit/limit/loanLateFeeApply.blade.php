                ...
                <tr>
                    <td>
                        <table border="0" width="90%" style="margin: 0 auto;" align="center" cellpadding="0">
                            <tr>
                                <td>
                                    <h1 style="font-size: 30px;color: #002050; text-align: left; margin-bottom: 10px;">Halo {{ isset($data) ? $data->user->full_name : ''}},</h1>
                                </td>
                            </tr>
                        </table>
                    </td>
                            ...
                            <tr>
                                <td style="">
                                    <table border="0" width="100%" style="margin: 0" align="center" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td>
                                                <p>Pinjaman Anda lewat jatuh tempo, di bawah biaya diterapkan pada pinjaman {{ isset($data) ? $data->loan_number : '' }} .</p>

                                                <p>Biaya jatuh tempo pinjaman: <strong>RP {{isset($data) ? number_format($data->loanTransactions->where('transaction_type_id',TRANSACTION_TYPE['LATE_FEE'])->first()->transaction_amount) : '0.00'}}</strong>.</p>
                                                <p>Jumlah Pelunasan Pinjaman:  <strong>RP {{isset($data) ? $data->loan_repay_amount : '0.00'}}</strong>.</p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
