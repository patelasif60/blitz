                                ...
                                <td style="">
                                    <table border="0" width="100%" style="margin: 0" align="center" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td>
                                                @if ($data->status)
                                                    <p>Pembayaran Anda berhasil dilakukan.</p>
                                                @else
                                                    <p>Pembayaran Anda gagal, coba lagi nanti.</p>
                                                @endif
                                                    <p>Pinjaman Disetujui: <strong>RP {{isset($data) ? $data->loan_amount : ''}}</strong>.</p>
                                                <p>Nomor Aplikasi Pinjaman: <strong>{{isset($data) ? $data->loan_number : ''}}</strong>.</p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
