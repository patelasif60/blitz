                            ...
                            <tr>
                                <td style="">
                                    <table border="0" width="100%" style="margin: 0" align="center" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td>
                                                <p>Terima kasih atas minat pengajuan kredit bisnis anda Bersama Blitznet. Bersama dengan ini kami menyampaikan tanggapan terhadap pengajuan kredit yang di terima pada <strong>{{\Carbon\Carbon::parse($data->created_at)->format('d-m-Y')}}</strong>. Bahwa pengajuan atas kredit tersebut ditolak.</p>
                                                ...
                                                <p>Batas Kredit: <strong>RP {{$data->loan_limit}}</strong>.</p>
