            ...
            <table style="border: 0; padding:0; margin:0 auto;text-align: left; width:750px; background-color:#fff; font-size:14px;font-family: Arial, sans-serif;" border="0" cellspacing="10" cellpadding="0" width="">
                ...
                <tr>
                    ...
                    <td style="color: #808080;font-size: 16px;">
                        ...
                        <br>
                        <p> Pesanan <strong>{{ $payment_due['order_no'] }}</strong> dengan Nominal <strong>{{ $payment_due['amount'] }}</strong>  telah di terima dan tagihan pembayaran nya sudah memasuki jatuh tempo. </p>
                        <p> Mohon tindak lanjut nya ke pihak terkait. </p>
                    </td>
                </tr>
            </table>
        </td>
