        ...
        <td align="center" style="background-color: #f9f9f9;">
            <table style="border: 0; padding:0; margin:0 auto;text-align: left; width:750px; background-color:#fff; font-size:14px;font-family: Arial, sans-serif;" border="0" cellspacing="10" cellpadding="0" width="">
                ...
                <tr>
                    ...
                    <td style="color: #808080;font-size: 16px;">
                        <p>Penawaran atas @NomorQuotation dengan @NamaProduk dan @Jumlah yang anda kirimkan pada @TanggalkirimQuotation sudah habis masa berlaku nya. Silahkan kontak Pembeli untuk kepastian pemesanan produk. </p>
                        <p> Untuk Quotation <strong>{{ $days['quote_number'] }}</strong> dengan  <strong>{{ $days['product_name'] }}</strong> dan <strong>{{ $days['qty'] . ' ' . $days['unit_name']  }}</strong> yang terkirim pada <strong>{{ $days['created']->format('m/d/Y') }}</strong>, sudah tidak berlaku. Untuk menerima penawaran baru silahkan membuat RFQ baru. </p>
