...
namespace App\Jobs;
use App\Mail\GroupRangeChangedBuyer;
...
class GroupRangeChangedBuyerJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        foreach ($groupBuyers as $groupBuyer){
            ...
            Mail::to($user->email)->bcc($ccUsers)->queue(new GroupRangeChangedBuyer($group,$buyer_name,$this->url,$this->shareLinks));
        }
    }
}
